                    ...
                    <table class="table table-striped c-box-shadow" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td style="border: 1px;">
                                ...
                                <a href="/uploads/images/{{$question->image_link}}" data-uk-lightbox="{group:'my-group'}"  width="800" height="800"><img src="/uploads/images/{{$question->image_link}}" width="200" height="200" alt=""></a>
                                @endif
                            </td>
                        </tr>
                        <?php $i++; ?>
